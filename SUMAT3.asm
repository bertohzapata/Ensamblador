...
;REALICE LA SUMATORIA: 1^2+3^2+5^2+7^2+...+(2N-1)^2

;RESTRICCIÓN: EL VALOR MÁXIMO DE N ES 128, DE LO CONTRARIO SE PASARÍA DE 2^16 Y EL RESULTADO NO SE PODRÍA MOSTRAR POR PANTALLA.
...
CODIGO SEGMENT	
	...
	MOV BX, 2
	MUL BX
	DEC AX			;SE DECLARA (2N-1)
	MOV BX, AX		;PARA QUE SE MULTIPLIQUE POR EL MISMO RESULTADO.
	MOV CX, 1		;SE DECLARA (2N-1)^2
CICLO:
	MUL BX
	LOOP CICLO
	CALL IMPRIMIR
