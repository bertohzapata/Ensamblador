...
;RESTRICCIÓN: EL VALOR MÁXIMO DE N DEBE SER 23, DE LO CONTRARIO SE PASARÁ DE 2^16.
...
CODIGO SEGMENT	
	...
	DEC AX					;SE DECREMENTA UNA UNIDAD AL NÚMERO INGRESADO.
	MOV CX, AX
CICLO:
	POP AX					;ANALIZAR MUY BIEN ESTA PARTE EN LA PRUEBA DE ESCRITORIO.
	POP BX
	PUSH BX
	PUSH AX
	ADD AX, BX
	...
	INT 21H
			...
			LECTURATECLA PROC			;INGRESO DE NÚMEROS POR TECLADO.
				...
				ETIQ2:
					...
					CMP N, 2H			;SE DEFINE EL TOPE DE DÍGITOS QUE SE TIENEN QUE INGRESAR. SE HACE ESTA COMPARACIÓN EN ESTA PARTE PARA QUE CUANDO SE LLEGUE 
