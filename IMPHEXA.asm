...
;A TENER EN CUENTA:	*HECHO MEDIANTE LA OPERACIÓN LÓGICA AND Y ROTACIÓN DE BITS ROR DE 4 EN 4, EMPEZANDO DESDE 12 Y TERMINANDO EN 4.
;					*LOS VALORES DE LAS VARIABLES QUE ESTÁN EN EL DS JUEGAN UN PAPEL IMPORTANTE CUANDO SE HACE CADA AND.
;					*EL NÚMERO MÁXIMO QUE SE PUEDE IMPRIMIR O MOSTRAR EN PANTALLA ES 65535=FFFF.
;					*EN EL CASO EN QUE SE DEBA IMPRIMIR UN NÚMERO ENTRE 0 Y 9 SE SUMA 30 PARA HACER LA CONVERSIÓN ASCCI-DECIMAL (LÍNEA 48).
;					*EN EL CASO EN QUE SE DEBA IMPRIMIR UN NÚMERO ENTRE A(10) Y F(15) SE SUMA 37 PARA HACER LA CONVERSIÓN ASCCI-HEXADECIMAL (LÍNEA 52).
