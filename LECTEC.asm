...
ETIQ1:
	CALL SALTOLINEA
	CMP N, 1H		;SI N=1 ES PORQUE SE HA INGRESADO UN SÓLO NUMERO (0-9)
	JNE ETIQ3
	POP DX
	MOV AH, 02H
	INT 21H
	JMP FIN
ETIQ3:
	CMP N, 2H		;SI N=2 ES PORQUE SE HA INGRESADO DOS NÚMEROS (10-99).
	JNE ETIQ4
	POP DX			
	...
	CALL IMPRIMIR
ETIQ4:
	CMP N, 3H		;SI N=3 ES PORQUE SE HAN INGRESADO 3 DÍGITOS (100-999).
	JNE FIN
	POP DX			
	SUB DL, 30H		;PARA CONVERTIR DE ASCII A DECIMAL.
