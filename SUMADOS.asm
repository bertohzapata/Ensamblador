...
;REALICE UN PROGRAMA QUE SUME DOS NÚMEROS INGRESADOS POR TECLADO, CADA NUMERO PUEDE TENER ENTRE UN 1 Y 4 DÍGITOS DECIMALES.

CODIGO SEGMENT	
	MOV AX,DATOS
	MOV DS,AX
	
ETIQ5:					;INGRESO DE NÚMEROS POR TECLADO.
	MOV AH, 9H
	LEA DX, MENSAJE 
	INT 21H
ETIQ2:
...
ETIQ7:
	...
	INC D 
	JMP PROCEPRINCIPAL
PROCEPRINCIPAL:			;D CUENTA LAS VECES QUE SE HAN INGRESADO NÚMEROS.
