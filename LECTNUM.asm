...
;					*INSTRUCCIÓN LEA.
;					*PONER AH EN CEROS CUANDO SE UTILICE UN SERVICIO (LÍNEA 34).
;					*CONVERSIÓN DE ASCCI A DECIMAL (LÍNEA 47).
...
;					*EN EL CASO QUE SE DEBA INGRESAR UN NÚMERO DE DÍGITOS MENORES A 5 SE DEBE TAMBIÉN MODIFICAR LA LÍNEA 39.
