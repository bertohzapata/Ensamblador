...
;					*EN ESTE CASO, DE ELEMENTOS DE 16 BITS, EL INCREMENTO DE BX VA DE 2 EN 2 DEBIDO A QUE LOS ELEMENTOS DEL VECTOR SON DE 16 BITS (LÍNEA 26).
...
;					*IMPORTANTE INICIALIZAR A BX (índice del vector) EN LA DIRECCIÓN EN MEMORIA DE LA VARIABLE VECTOR MEDIANTE EL USO DE OFFSET (LÍNEA 23).
