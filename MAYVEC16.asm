...
;					*CX TIENE COMO FUNCIÓN DETERMINAR EL TAMAÑO DEL VECTOR. 
;					*BX Y CX SON DEPENDIENTES UNO DEL OTRO.
;					*EN ESTE CASO, DE ELEMENTOS DE 16 BITS, EL INCREMENTO DE BX VA DE 2 EN 2 DEBIDO A QUE LOS ELEMENTOS DEL VECTOR SON DE 16 BITS (LÍNEA 29).
...
;					*IMPORTANTE INICIALIZAR A BX (índice del vector) EN LA DIRECCIÓN EN MEMORIA DE LA VARIABLE VECTOR MEDIANTE EL USO DE OFFSET (LÍNEA 25).
;					*EL CICLO FOR (LOOP) EMPIEZA EN CERO Y TERMINA EN (TAMAÑO_VECTOR-1) (LÍNEA 28).
;					*EN LA LÍNEA 27 SE DEFINE EL SOPORTE PARA NÚMEROS REPETIDOS, MEDIANTE 'MAYOR O IGUAL'.
...
;					*VECTOR[BX+desp] ES LO MISMO QUE TENER [BX+desp]. LO IMPORTANTE ESTÁ EN EL MODO DE DIRECCIONAMIENTO.
