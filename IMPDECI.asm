...
DATOS SEGMENT
I DW 0H ;CUENTA LA CANTIDAD DE VECES QUE SE HA INGRESADO UN DATO EN LA PILA (SE HA DIVIDIDO AX), ESTO CON EL FIN DE SABER 
			;CUÁNTAS VECES SE DEBE DE SACAR UN DATO DE LA PILA PARA PODER SER IMPRIMIDO EN PANTALLA.
