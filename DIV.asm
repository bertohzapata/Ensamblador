...
CODIGO SEGMENT	
	...
	;DIVIDIR DOS NUMEROS, LOS OPERANDOS Y EL RESULTADO SON DE 8 BITS Y ESTÁN ALMACENADOS EN MEMORIA: (OPERACIÓN 2)
	
	;LOS DOS OPERANDOS SON DE 8 BITS Y PARA USAR LA OPERACIÓN 2 SE DEBE PRIMERO ACOMODAR EL REGISTRO AX PARA QUE NO PRESENTE ERROR.
	;PARA ELLO SE RELLENA DE CEROS LA PARTE ALTA AH Y PUEDA HACERSE LA OPERACIÓN:
